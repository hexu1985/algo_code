...
int main() {
    ...
    any a1(std::shared_ptr<A>(new A));
    any a2(std::string("Just a string"));

    {
        any b1(std::shared_ptr<A>(new B));
        any b2(std::shared_ptr<B>(new B));
        std::vector<any> vec;
        vec.push_back(a1);
        vec.push_back(a2);
        vec.push_back(b1);
